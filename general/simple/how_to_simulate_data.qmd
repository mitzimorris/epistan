...
hello_data = hello_datagen.sample(data={"N_obs":100}, chains=1, iter_warmup=0, iter_sampling=10)
```
...
```{python}
for i in range(10):
    print('alpha', data_p0_g2.alpha[])
    print('sigma_age', data_p0_g2.sigma_age[], 'beta_age', data_p0_g2.beta_age[])
    print('sigma_eth', data_p0_g2.sigma_eth[], 'beta_eth', data_p0_g2.beta_eth[])
    print('positive tests: ', data_p0_g2.pos_tests[].astype(int), '\n')
```
